<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Movie6.aspx.cs" Inherits="AIMDB.Movie6" %>


<!DOCTYPE html>
<html>
<head>
<title>AIMDB - Gone with the Wind</title>
<meta charset="UTF-8">
...
.bgimg {
    ...
    background-image: url(/img/posters/6.jpg);
    min-height: 100%;
}
.hidden { display: none; }
.review {
...
<div class="w3-main w3-padding-large" style="margin-left:40%">
  ...
  <header class="w3-container w3-center" style="padding:128px 16px" id="home">
    <h1 class="w3-jumbo"><b>Gone with the Wind</b></h1>
           <%movieinfo("Gone with the Wind");%>
    <p>Year: <asp:label ID="year" runat="server"></asp:label><br />
       ...
       Rating: <asp:label ID="rate" runat="server"></asp:label><br />
           <%moviereview("Gone with the Wind"); %>
