<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Movie3.aspx.cs" Inherits="AIMDB.Movie3" %>


<!DOCTYPE html>
<html>
<head>
<title>AIMDB - The Wolf of Wall Street</title>
<meta charset="UTF-8">
...
.bgimg {
    ...
    background-image: url(/img/posters/3.jpg);
    min-height: 100%;
}
.hidden { display: none; }
.review {
...
<div class="w3-main w3-padding-large" style="margin-left:40%">
  ...
  <header class="w3-container w3-center" style="padding:128px 16px" id="home">
    <h1 class="w3-jumbo"><b>The Wolf of Wall Street</b></h1>
           <%movieinfo("The Wolf of Wall Street");%>
    <p>Year: <asp:label ID="year" runat="server"></asp:label><br />
       ...
       Rating: <asp:label ID="rate" runat="server"></asp:label><br />
           <%moviereview("The Wolf of Wall Street"); %>
