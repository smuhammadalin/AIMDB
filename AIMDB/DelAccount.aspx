<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DelAccount.aspx.cs" Inherits="AIMDB.DelAccount" %>
...
<head runat="server">
    ...
    <title>AIMDB - Delete Account</title>
            ...
            <div class="row">
               ...
               <div class="col-md-4">
                  <div class="panel panel-default black">
                     ...
                     <asp:Button ID="sibutton" runat="server" Text="Delete Account" OnClick="delaccountclick"></asp:Button><br /> <br />
                  </div>
