<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Movie10.aspx.cs" Inherits="AIMDB.Movie10" %>


<!DOCTYPE html>
<html>
<head>
<title>AIMDB - The Intern</title>
<meta charset="UTF-8">
...
.bgimg {
    ...
    background-image: url(/img/posters/10.jpg);
    min-height: 100%;
}
.hidden { display: none; }
.review {
...
<div class="w3-main w3-padding-large" style="margin-left:40%">
  ...
  <header class="w3-container w3-center" style="padding:128px 16px" id="home">
    <h1 class="w3-jumbo"><b>The Intern</b></h1>
           <%movieinfo("The Intern");%>
