<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Movie2.aspx.cs" Inherits="AIMDB.Movie2" %>

<!DOCTYPE html>
<html>
<head>
<title>AIMDB - The Revenant</title>
<meta charset="UTF-8">
...
<div class="w3-main w3-padding-large" style="margin-left:40%">
  ...
  <header class="w3-container w3-center" style="padding:128px 16px" id="home">
    <h1 class="w3-jumbo"><b>The Revenant</b></h1>
           <%movieinfo("The Revenant");%>
